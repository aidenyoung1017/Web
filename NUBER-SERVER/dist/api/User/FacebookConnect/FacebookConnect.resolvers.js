...
var resolvers = {
    Mutation: {
        FacebookConnect: function (_, args) { return __awaiter(_this, void 0, void 0, function () {
            var fbId, existingUser, token, error_1, newUser, token, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, User_1.default.findOne({ fbId: fbId })];
                    case 2:
                        existingUser = _a.sent();
                        if (existingUser) {
                            token = createJWT_1.default(existingUser.id);
                            return [2 /*return*/, {
                                    ok: true,
                                    error: null,
                                    token: token
...
//# sourceMappingURL=FacebookConnect.resolvers.js.map